...
btnAnadir.addEventListener('click', () => {
    ...
    mensaje.innerHTML = valor + " se ha añadido de manera exitosa "
})
...
btnCalcular.addEventListener('click', () => {
    ...
    mensaje.innerHTML = valor + "$ es el costo total de " + producto.producto
})
...
btnBorrarPrimero.addEventListener('click', () => {
    ...
    if(valor !== false){
        mensaje.innerHTML = "Se ha eliminado de manera exitosa el producto: " + valor
    }else{
...
btnBorrar.addEventListener('click', () => {
    ...
    if (valor == false){
        mensaje.innerHTML = "No se ha encontrado el producto"
    }else{
        mensaje.innerHTML = "Ha sido elimnado de manera exitosa el producto " + valor
    }
})
...
btnBuscar.addEventListener('click', () => {
    ...
    if (almacen.buscarProductoID(codigo) == false){
        ...
        mensaje.innerHTML = "Se encontró " + valor
    }
})
...
let p1 = new Producto(1334, "Leche", "Lácteos", 18, 2)
let p2 = new Producto(1345, "Tocino", "Carnes", 30, 10)
let p3 = new Producto(1231, "Cheetos flaming hot", "Sabritas", 10, 500)
let p4 = new Producto(1414, "Corn Flakes", "Cereales", 6, 500)
